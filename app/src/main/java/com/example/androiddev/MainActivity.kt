...
//import@Composable androidx.compose.material.Text
import com.example.androiddev.ui.theme.AndroidDevTheme
...
//                }
                Column {
                    Text(text = "Tanushree-Panda", color = Color.Yellow , fontSize = 30.sp, fontStyle = FontStyle.Italic, fontWeight = FontWeight.Bold)
